...
public class favoriteSalads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorite_salads);

        list_dishes= findViewById(R.id.list_dishes);
        ref= FirebaseDatabase.getInstance().getReference().child("Users").child("Members").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("favoriteDishes").child("salads");
        reff=FirebaseDatabase.getInstance().getReference().child("dishInformation").child("salads");
        reff2= FirebaseDatabase.getInstance().getReference("order").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("salads");
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(favoriteSalads.this);
                ...
                mBuilder.setPositiveButton("order", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i= new Intent(favoriteSalads.this, favoriteSalads.class);
                        startActivity(i);
                    }});
                ...
                mBuilder.setNegativeButton("Delete from favorites", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity(new Intent(favoriteSalads.this, favoriteSalads.class));
                    }
                });
