...
public class favoriteDesserts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorite_desserts);
        ...
        ref= FirebaseDatabase.getInstance().getReference().child("Users").child("Members").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("favoriteDishes").child("desserts");
        reff=FirebaseDatabase.getInstance().getReference().child("dishInformation").child("desserts");
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(favoriteDesserts.this);
                ...
                mBuilder.setPositiveButton("order", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i= new Intent(favoriteDesserts.this, favoriteDesserts.class);
                        startActivity(i);
                    }});
