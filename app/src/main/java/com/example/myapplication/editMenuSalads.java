...
public class editMenuSalads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(editMenuSalads.this);
                ...
                mBuilder.setPositiveButton("edit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i= new Intent(editMenuSalads.this, editDish.class);
                ...
                mBuilder.setNegativeButton("delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) { ;
                        ...
                        startActivity(new Intent(editMenuSalads.this, editMenuSalads.class));
                    }
                });
