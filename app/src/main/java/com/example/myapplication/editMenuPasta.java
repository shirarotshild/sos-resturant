...
public class editMenuPasta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(editMenuPasta.this);
                ...
                mBuilder.setPositiveButton("edit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i= new Intent(editMenuPasta.this, editDish.class);
                ...
                mBuilder.setNegativeButton("delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) { ;
                        ...
                        startActivity(new Intent(editMenuPasta.this, editMenuPasta.class));
                    }
                });
