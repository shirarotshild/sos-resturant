...
public class editMenuPizza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(editMenuPizza.this);
                ...
                mBuilder.setPositiveButton("edit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i= new Intent(editMenuPizza.this, editDish.class);
                ...
                mBuilder.setNegativeButton("delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) { ;
                        ...
                        startActivity(new Intent(editMenuPizza.this, editMenuPizza.class));
                    }
                });
