...
public class favoritePizzas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorite_pizzas);
        setContentView(R.layout.activity_favorite_drink);
        list_dishes= findViewById(R.id.list_dishes);
        reff2= FirebaseDatabase.getInstance().getReference("order").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("pizzas");
        ...
        ref= FirebaseDatabase.getInstance().getReference().child("Users").child("Members").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("favoriteDishes").child("pizzas");
        reff=FirebaseDatabase.getInstance().getReference().child("dishInformation").child("pizzas");
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(favoritePizzas.this);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        reff2.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                reff2.child(dish.getDish_key_()).setValue(count);
                        ...
                        Intent i= new Intent(favoritePizzas.this, favoritePizzas.class);
                        startActivity(i);
                    }});

                mBuilder.setNegativeButton("Delete from favorites", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getApplicationContext(), "Delete", Toast.LENGTH_SHORT).show();
                        ref.child(dish.getDish_key_()).removeValue();
                        startActivity(new Intent(favoritePizzas.this, favoritePizzas.class));
                    }
                });
