...
public class orderPizzas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_pizzas);
        reff= FirebaseDatabase.getInstance().getReference("order").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("pizzas");
        ref= FirebaseDatabase.getInstance().getReference("dishInformation").child("pizzas");
        ...
        list_dishes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(orderPizzas.this);
                ...
                mBuilder.setPositiveButton("Add another one", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i= new Intent(orderPizzas.this, orderPizzas.class);
                ...
                mBuilder.setNegativeButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) { ;
                        ...
                        startActivity(new Intent(orderPizzas.this, orderPizzas.class));
                    }
                });
